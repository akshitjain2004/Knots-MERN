          ...
          <Link to="/service/vendors/Ambrosia">
            <div className="imgbor">
              <div className="img">
                ...
                <div className="text">Ambrosia Sarovar Portico </div>
                <img src={loc} className="locimg" alt=""></img>
                <div className="location">Hyderbad</div>
                <img src={eye} className="eye" alt=""></img>
                <div className="view">600 views</div>
                <hr className="hr"></hr>
                <img src={rup} className="rup" alt=""></img>
        ...
        <div className="box">
          <div className="imgbor">
            <div className="img">
              ...
              <div className="text">The VrindWoods </div>
        ...
        <div className="box">
          <div className="imgbor">
            <div className="img">
              ...
              <div className="text">The Mark Hotel & Club </div>
              <img src={loc} className="locimg"></img>
        ...
        <div className="box">
          <div className="imgbor">
            <div className="img">
              ...
              <div className="text">Hyatt Centric Rajpur Road </div>
              <img src={loc} className="locimg"></img>
        ...
        <div className="box">
          <div className="imgbor">
            <div className="img">
              ...
              <div className="text">Kadamb Resort </div>
              <img src={loc} className="locimg"></img>
        ...
        <div className="box">
          <div className="imgbor">
            <div className="img">
              ...
              <div className="text">Jalsa Banquets </div>
              <img src={loc} className="locimg"></img>
